package se.stade.flash.dom.manipulation.mxml.adobe
{
    import se.stade.flash.dom.manipulation.mxml.MXMLManifest;

    public final class SparkManifest extends MXMLManifest
    {
        public static const instance:SparkManifest = new SparkManifest;
        
        public function SparkManifest()
        {
            super("library://ns.adobe.com/flex/spark",
                  <componentPackage>
                        <!--
